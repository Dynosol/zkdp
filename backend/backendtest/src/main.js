...
async function initializeRunner(n, x) {
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/new', {
        method: 'POST',
        headers: {
...
async function getCommitments() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/commits', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function sendRandomness(bits) {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/randomness', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function getPublicRandom() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/public_random', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function getXorBits() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/xor_bits', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function getXorCommits() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/xor_commits', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function computeSum() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/compute_sum', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function getZ() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/z', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function commitPedersons() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/commit_pedersons', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function getLhs() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/lhs', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function getRhs() {
    ...
    const response = await (0, node_fetch_1.default)('http://127.0.0.1:9537/rhs', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
